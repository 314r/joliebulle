...
class ComboBoxDelegate(QtGui.QItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        self.listeF = AppWindow()
        print ('la liste des Form dans le createeditor: ', self.listeF.liste_hForm)
    ...
    def setEditorData( self, comboBox, index ):
        ...
        if value == 'Pellet' : 
            ...
            value = 1
        print('value dans le seteditor :', value)
...
class AppWindow(QtGui.QMainWindow,Ui_MainWindow):
    ...
    def __init__(self, parent = None):
        ...
        liste_headers = ["Ingrédients","Quantité (g)","Temps (min)","Acide Alpha (%)","Type"]
    ...
    def MVC(self) : 
        #recette.lineEditRecette.setText(recette.nomRecette)
        ...
        print ('la liste des Form dans le MVC: ', self.liste_hForm)
    ...
    def ajouterF(self) :
        #self.modele.insertRow(1)
        #item = QtGui.QStandardItem(self.base.liste_ingr[2])
        #self.modele.setItem(1,0,item)
        #i = int(self.comboBox.currentIndex)
        #print(self.base.liste_ingr[i])
        ...
        #self.modele.setItem(f,0,item)
        #self.modele.setItem(f,1,item_fAmount)
        ...
        #self.liste_ingr.append(self.base.liste_ingr[i])
        #self.liste_fAmount.append(self.base.liste_fAmount[i])
        #self.liste_fYield.append(self.base.liste_fYield[i])
        #self.liste_color.append(self.base.liste_color[i])
        #self.liste_fType.append(self.base.liste_fType[i])
        #print(self.liste_ingr)
        #print(AppWindow.nbreFer)
        self.MVC()
    ...
    def ajouterH(self) : 
        ...
        #self.modele.setItem(f+h, 0, itemH)
        #self.modele.setItem(f+h, 1, item_hAmount)
        #self.modele.setItem(f+h, 2, item_hTime)
        #self.modele.setItem(f+h,3,item_hAlpha)
    ...
    def ajouterY(self) :
        ...
        #self.modele.setItem(f+h+m+l,0,item_levuresDetail)
    ...
    def calculs_recette (self) :
        ...
        #print (self.base.liste_levuresDetail)
    ...
    def ouvrir_clicked (self) : 
        ...
        print ("une liste au moment de l'ouverture :", self.liste_hAmount)
    ...
    def rendemt_changed(self) :
        if self.checkBoxIng.isChecked() :
            ...
            print ("et le ratio rendement eeest : ", ratio)
            i = 0
            while i < AppWindow.nbreFer :
                i = i +1 
    ...
    def volume_changed(self) :
        ...
        if self.checkBoxIng.isChecked() :
            ...
            while m < AppWindow.nbreDivers :
                ...
                amount = QtGui.QStandardItem("%.0f" %(self.liste_dAmount[m-1]) )
                self.modele.setItem(i+h+m-1, 1, amount)
            print('la liste en question',self.liste_dAmount)
            self.calculs_recette()
    ...
    def enregistrer (self) :
        ...
        if not self.s : 
            ...
            print (self.lineEditRecette.text())
    ...
    def nouvelle(self) :
        self.nomRecette = 'Nouvelle Recette'
        self.rendement = 75
        self.volume = '10'
        self.boil = '60'
        self.styleRecette = '''Générique'''
